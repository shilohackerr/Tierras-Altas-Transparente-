...
const ICONS = {
  money:    `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M16 8h-6a2 2 0 000 4h4a2 2 0 010 4H8"/><path d="M12 6v2m0 8v2"/></svg>`,
  spending: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>`,
  sync:     `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 11-2.12-9.36L23 10"/></svg>`,
  bank:     `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg>`,
  bars:     `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>`,
  ...
  file:     `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>`,
  pdf:      `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="15" y2="17"/></svg>`,
  ...
  pin:      `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/><circle cx="12" cy="9" r="2.5"/></svg>`,
  ...
  process:  `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 11-2.12-9.36L23 10"/></svg>`,
  pending:  `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`,
  car:      `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M5 17H3a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v5h-3"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/></svg>`,
  store:    `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M3 9l1-4h16l1 4"/><rect x="2" y="9" width="20" height="12" rx="1"/><line x1="12" y1="9" x2="12" y2="21"/></svg>`,
  ...
  hammer:   `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M15.45 6.83L11 2.38c-.78-.78-2.05-.78-2.83 0L2.38 8.17c-.78.78-.78 2.05 0 2.83l4.45 4.45"/><path d="M22 22l-7.5-7.5"/><path d="M9 15l5.5 5.5"/></svg>`,
  tax:      `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M9 14l2 2 4-4"/><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>`,
  lock:     `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>`,
  vote:     `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>`,
  thumb:    `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M14 9V5a3 3 0 00-3-3l-4 9v11h11.28a2 2 0 002-1.7l1.38-9a2 2 0 00-2-2.3H14z"/><path d="M7 22H4a2 2 0 01-2-2v-7a2 2 0 012-2h3"/></svg>`,
  ...
  alert:    `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>`,
  location: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="3"/><path d="M12 1v4M12 19v4M4.22 4.22l2.83 2.83M16.95 16.95l2.83 2.83M1 12h4M19 12h4M4.22 19.78l2.83-2.83M16.95 7.05l2.83-2.83"/></svg>`,
  road:     `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M3 17l3-12h12l3 12M12 5v16"/></svg>`,
  ...
  sign:     `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><rect x="2" y="7" width="20" height="10" rx="1"/><line x1="12" y1="17" x2="12" y2="22"/></svg>`,
  building: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><rect x="4" y="2" width="16" height="20" rx="1"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01M16 6h.01M8 10h.01M16 10h.01M8 14h.01M16 14h.01"/></svg>`,
  other:    `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>`,
  progress: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>`,
...
function renderBarChart() {
  ...
  // SVG puro — el único método 100% confiable en todos los navegadores móviles
  // Sin flexbox, sin CSS variables, sin dependencias de layout
  const W = 560, H = 120, BAR_W = 22, GAP = 8, GROUP_W = 90;
  const AZUL = '#1e53e5', VERDE = '#00e64d', LABEL_COLOR = '#8892b0';

  const groups = data.map((c, i) => {
    const x     = i * (GROUP_W + 10) + 15;
    const hR    = Math.max(4, Math.round((c.recibidoPct  / 100) * H));
    const hE    = Math.max(4, Math.round((c.ejecutadoPct / 100) * H));
    const xR    = x;
    const xE    = x + BAR_W + GAP;
    const yR    = H - hR;
    const yE    = H - hE;
    // Nombre corto para el label
    const nombre = c.nombre.length > 8 ? c.nombre.substring(0, 8) : c.nombre;

    return `
      <rect x="${xR}" y="${yR}" width="${BAR_W}" height="${hR}"
            fill="${AZUL}" rx="3"
            aria-label="${c.nombre}: Recibido ${c.recibidoPct}%">
        <title>${c.nombre}: Recibido ${c.recibidoPct}%</title>
      </rect>
      <rect x="${xE}" y="${yE}" width="${BAR_W}" height="${hE}"
            fill="${VERDE}" rx="3"
            aria-label="${c.nombre}: Ejecutado ${c.ejecutadoPct}%">
        <title>${c.nombre}: Ejecutado ${c.ejecutadoPct}%</title>
      </rect>
      <text x="${xR + BAR_W}" y="${H + 16}" text-anchor="middle"
            font-family="system-ui,sans-serif" font-size="9"
            font-weight="600" fill="${LABEL_COLOR}"
            letter-spacing="0.3">${nombre.toUpperCase()}</text>`;
  }).join('');

  const TOTAL_W = data.length * (GROUP_W + 10) + 20;

  container.innerHTML = `
    <svg width="100%" height="${H + 30}"
         viewBox="0 0 ${TOTAL_W} ${H + 30}"
         role="img"
         aria-label="Gráfico de ejecución presupuestaria por corregimiento"
         xmlns="http://www.w3.org/2000/svg"
         style="display:block;overflow:visible">
      <title>Ejecución presupuestaria por corregimiento 2026</title>
      <desc>Barras azules muestran % recibido, barras verdes muestran % ejecutado por corregimiento.</desc>
      <!-- Línea base -->
      <line x1="0" y1="${H}" x2="${TOTAL_W}" y2="${H}"
            stroke="#dde1f0" stroke-width="1"/>
      ${groups}
    </svg>`;
}
  ...
  container.innerHTML = list.map(p => {
    ...
    <div class="proyecto-card" role="listitem" data-id="${p.id}" tabindex="0"
      ...
      <div class="proyecto-update" aria-label="Última actualización">
        <span class="proyecto-update-time">
          <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:inline-block;vertical-align:middle;margin-right:3px;color:var(--verde)"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
          ${upd.tiempo}
        </span>
    ...
    return `
      <div class="voto-card" role="listitem">
        ...
        <div class="voto-bar-wrap" role="progressbar" aria-valuenow="${p.votos}" aria-valuemax="${p.maxVotos}" aria-label="${p.votos} votos de ${p.maxVotos}">
          ...
          <div class="voto-count" aria-hidden="true">${p.votos.toLocaleString('es-PA')}</div>
        </div>
        <div class="voto-actions">
          <button class="btn-voto" id="voto-${p.id}"
                  data-voto-id="${p.id}" data-votos="${p.votos}"
                  aria-label="Apoyar propuesta: ${p.nombre}. ${p.votos} apoyos">
...
// Lock para prevenir votos duplicados bajo alta concurrencia (pico de cierre)
const _voteLocks = new Set();

function toggleVoto(id, currentVotes) {
  // Prevenir doble-clic / múltiples toques simultáneos
  if (_voteLocks.has(id)) return;
  _voteLocks.add(id);

  const btn      = document.getElementById(`voto-${id}`);
  const propuesta = PROPUESTAS_ACTIVAS.find(p => p.id === id);
  if (!btn || !propuesta) { _voteLocks.delete(id); return; }

  const voted     = btn.classList.toggle('voted');
  propuesta.votos = voted ? propuesta.votos + 1 : Math.max(0, propuesta.votos - 1);

  // Actualizar solo el botón y el contador — sin re-renderizar toda la lista
  // Esto evita la race condition de renderVotaciones() bajo tráfico alto
  const iconHtml  = voted
    ? `<span style="width:15px;height:15px;display:inline-block" aria-hidden="true">${ICONS.check}</span>`
    : `<span style="width:15px;height:15px;display:inline-block" aria-hidden="true">${ICONS.thumb}</span>`;
  btn.innerHTML = `${iconHtml} ${voted ? 'Apoyado' : 'Apoyar'}`;
  btn.setAttribute('aria-label',
    `${voted ? 'Quitar apoyo' : 'Apoyar'} propuesta: ${propuesta.nombre}. ${propuesta.votos} apoyos`
  );
  btn.setAttribute('data-votos', propuesta.votos);

  // Actualizar el contador de votos en el DOM quirúrgicamente
  const card      = btn.closest('.voto-card');
  const countEl   = card?.querySelector('.voto-count');
  ...
  // Liberar lock después de 400ms — evita doble-click accidental en móvil
  setTimeout(() => _voteLocks.delete(id), 400);
}
...
function previewFiles(input) {
  ...
  const MAX_SIZE_MB  = 5;       // máximo por archivo
  const MAX_FILES    = 3;       // máximo 3 fotos
  const MAX_DIM      = 1280;    // redimensionar a máx 1280px — reduce peso en 3G
  const archivos     = Array.from(input.files).slice(0, MAX_FILES);
  ...
  archivos.forEach((file, idx) => {
    ...
    if (!file.type.startsWith('image/')) {
      _mostrarErrorFoto(`Archivo ${idx + 1}: solo se permiten imágenes.`);
      return;
    }
    // Validar peso
    if (file.size > MAX_SIZE_MB * 1024 * 1024) {
      _mostrarErrorFoto(`Imagen ${idx + 1} supera ${MAX_SIZE_MB}MB. En redes lentas esto puede fallar.`);
      return;
    }

    // Contenedor con loading skeleton mientras procesa
    const wrap = document.createElement('div');
    wrap.className = 'foto-preview-wrap';
    wrap.style.cssText = 'position:relative;width:72px;height:72px;border-radius:8px;background:#e8ecf8;overflow:hidden;flex-shrink:0;';
    preview.appendChild(wrap);

    // Comprimir imagen usando canvas antes de mostrar vista previa
    // Reduce consumo de memoria en dispositivos de gama baja
    const reader = new FileReader();
    reader.onload = ev => {
      const imgEl = new Image();
      imgEl.onload = () => {
        // Canvas de compresión
        const canvas  = document.createElement('canvas');
        const ratio   = Math.min(MAX_DIM / imgEl.width, MAX_DIM / imgEl.height, 1);
        canvas.width  = Math.round(imgEl.width  * ratio);
        canvas.height = Math.round(imgEl.height * ratio);
        const ctx = canvas.getContext('2d');
        ctx.drawImage(imgEl, 0, 0, canvas.width, canvas.height);

        const dataUrl = canvas.toDataURL('image/jpeg', 0.75); // 75% calidad — balance 3G

        const preview_img = document.createElement('img');
        preview_img.src   = dataUrl;
        preview_img.alt   = `Vista previa foto ${idx + 1}`;
        preview_img.style.cssText = 'width:100%;height:100%;object-fit:cover;';
        wrap.appendChild(preview_img);

        // Mostrar tamaño comprimido
        const sizeKB  = Math.round(dataUrl.length * 0.75 / 1024);
        const badge   = document.createElement('span');
        badge.textContent = `${sizeKB}KB`;
        badge.style.cssText = 'position:absolute;bottom:2px;right:2px;background:rgba(0,0,0,.6);color:#fff;font-size:9px;padding:1px 4px;border-radius:3px;';
        badge.setAttribute('aria-hidden', 'true');
        wrap.appendChild(badge);
      };
      imgEl.onerror = () => _mostrarErrorFoto(`No se pudo procesar la imagen ${idx + 1}.`);
      imgEl.src = ev.target.result;
    };
    reader.onerror = () => _mostrarErrorFoto(`Error al leer el archivo ${idx + 1}.`);
    reader.readAsDataURL(file);
  });

  // Advertencia si se seleccionaron más de MAX_FILES
  if (input.files.length > MAX_FILES) {
    _mostrarErrorFoto(`Solo se aceptan ${MAX_FILES} fotos. Se tomaron las primeras ${MAX_FILES}.`);
  }
}

function _mostrarErrorFoto(msg) {
  const el = document.getElementById('error-queja') || document.getElementById('error-propuesta');
  if (el) { el.textContent = msg; el.classList.add('visible'); setTimeout(() => el.classList.remove('visible'), 4000); }
}
...
function renderTickets(filtro) {
  ...
  container.innerHTML = filtered.map(t => {
    ...
    <div class="ticket-item" role="listitem" tabindex="0" aria-label="Reporte ${t.codigo}: ${t.tipo}">
      ...
      <div class="ticket-desc" style="display:flex;align-items:center;gap:.45rem;color:var(--gris-400)">
        <span style="width:16px;height:16px;flex-shrink:0;display:inline-block;color:var(--gris-400)" aria-hidden="true">
          ${(INCIDENCIA_ICONS[t.tipoKey] || ICONS.other).replace(/stroke="currentColor"/g, 'stroke="var(--gris-400)"')}
        </span>
        ${t.tipo} · ${t.lugar}
      </div>
      ...
      <div class="ticket-meta">
        <span style="display:flex;align-items:center;gap:.25rem;color:var(--gris-400)">
          <span style="width:12px;height:12px;display:inline-block;color:var(--gris-400)" aria-hidden="true">${ICONS.clock}</span>
          ${t.tiempo}
        </span>
        <span style="color:var(--gris-400)">${t.fecha}</span>
      </div>
    </div>`;
  }).join('');
}
...
function captureGeo() {
  ...
  const btnGeo  = document.getElementById('btnCaptureGeo');
  ...
  // Estado: buscando
  status.textContent = 'Buscando señal GPS... (puede tardar en zonas rurales)';
  status.classList.remove('captured');
  if (btnGeo) { btnGeo.disabled = true; btnGeo.setAttribute('aria-busy', 'true'); }

  let intentos = 0;
  const MAX_INTENTOS = 3;

  // Opciones progresivas: cada intento es menos exigente para redes lentas
  const opciones = [
    { timeout: 10000, maximumAge: 30000,  enableHighAccuracy: true  }, // Intento 1: alta precisión
    { timeout: 15000, maximumAge: 60000,  enableHighAccuracy: false }, // Intento 2: baja precisión
    { timeout: 20000, maximumAge: 120000, enableHighAccuracy: false }, // Intento 3: cualquier caché
  ];

  function intentarGPS() {
    intentos++;
    if (intentos > 1) {
      status.textContent = `Intento ${intentos}/${MAX_INTENTOS} — Red lenta detectada, ajustando precisión...`;
    }
    ...
    navigator.geolocation.getCurrentPosition(
      pos => {
        ...
        const precision = pos.coords.accuracy < 50 ? 'alta' : pos.coords.accuracy < 200 ? 'media' : 'aprox.';
        if (latEl) latEl.value = lat;
        if (lngEl) lngEl.value = lng;
        status.textContent = `Lat: ${lat}, Lng: ${lng} — Precisión ${precision}`;
        status.classList.add('captured');
        if (btnGeo) { btnGeo.disabled = false; btnGeo.removeAttribute('aria-busy'); }
      },
      err => {
        // Error — reintentar si quedan intentos
        if (intentos < MAX_INTENTOS) {
          setTimeout(intentarGPS, 1500);
          return;
        }

        // Agotados los intentos — fallback a coordenadas aproximadas del distrito
        // Tierras Altas, Chiriquí: 8.7653°N, 82.6304°W
        const lat = (8.7653 + (Math.random() - 0.5) * 0.02).toFixed(5);
        const lng = (-82.6304 + (Math.random() - 0.5) * 0.02).toFixed(5);
        if (latEl) latEl.value = lat;
        if (lngEl) lngEl.value = lng;

        const msg = err.code === 1
          ? 'Permiso GPS denegado. Se usará ubicación aproximada del distrito.'
          : 'GPS no disponible (red lenta). Ubicación aproximada asignada.';
        status.textContent = `${msg} Lat: ${lat}, Lng: ${lng}`;
        status.classList.add('captured');
        if (btnGeo) { btnGeo.disabled = false; btnGeo.removeAttribute('aria-busy'); }
      },
      opciones[intentos - 1]
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ── Botones de votar — delegación en el contenedor padre
  document.getElementById('votoCards')?.addEventListener('click', e => {
    const btn = e.target.closest('.btn-voto[data-voto-id]');
    if (!btn) return;
    toggleVoto(btn.dataset.votoId, parseInt(btn.dataset.votos));
  });
