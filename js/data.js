...
/* ── TICKETS 311 ── */
const TICKETS = [
  { codigo: '#TAQ-2026-1041', tipo: 'Luminaria apagada', tipoKey: 'luminaria', lugar: 'Av. Principal, Volcán',      estado: 'resuelto', tiempo: 'Resuelto en 48h', fecha: '6 mar 2026',  zona: 'volcan' },
  { codigo: '#TAQ-2026-1038', tipo: 'Bache profundo',    tipoKey: 'bache',     lugar: 'Calle 2da, Paso Ancho',      estado: 'proceso',  tiempo: 'Día 3',           fecha: '8 mar 2026',  zona: 'pasoancho' },
  { codigo: '#TAQ-2026-1035', tipo: 'Tubería rota',      tipoKey: 'agua',      lugar: 'Sector 4, Cerro Punta',      estado: 'proceso',  tiempo: 'Día 5',           fecha: '6 mar 2026',  zona: 'cerropunta' },
  { codigo: '#TAQ-2026-1029', tipo: 'Árbol caído',       tipoKey: 'arbol',     lugar: 'Camino rural, Río Sereno',   estado: 'abierto',  tiempo: 'Nuevo',           fecha: '10 mar 2026', zona: 'riosereno' },
  { codigo: '#TAQ-2026-1022', tipo: 'Basura acumulada',  tipoKey: 'basura',    lugar: 'B. El Porvenir, Volcán',     estado: 'resuelto', tiempo: 'Resuelto en 72h', fecha: '5 mar 2026',  zona: 'volcan' },
  { codigo: '#TAQ-2026-1018', tipo: 'Señal dañada',      tipoKey: 'senal',     lugar: 'Intersección Ruta 36',       estado: 'resuelto', tiempo: 'Resuelto en 24h', fecha: '4 mar 2026',  zona: 'cuestapiedra' },
];
...
const I18N = {
  ...
  ngabe: {
    ...
    hero_sub:              'Tärä nibi krörö: ño meri käite mün tärä, ño krörö tärä, ni tärä gwi iti, ño trämite mün tärä käite.',
    ...
    fiscal_sub:            'Tärä meri güe mün käite.',
    kpi1:                  'Meri kite jäkäre',
    kpi2:                  'Meri ngwane',
    kpi3:                  'Meri krörö käite',
    kpi4:                  'Meri tiribä',
    proyectos_sub:         'Tärä krörö tärä ni mapa gwi.',
    propuestas_sub:        'Ni kämikä tärä mün gwi. Käte kämikä krörö ngwane tärä mün.',
    form_propuesta_title:  'Ni kämikä tärä',
    cedula_ph:             'Ni cédula',
    cedula_hint:           'Ni cédula käite ne ti Tierras Altas gwi.',
    upload_hint:           'Ni foto tärä iti gwi',
    btn_enviar_propuesta:  '📨 Kämikä tärä',
    votacion_title:        '👍 Kämikä ngwane',
    quejas_sub:            'Ni iti tärä, mün ni krörö gwi numero.',
    ticket_title:          'Iti tärä',
    ticket_sub:            'Ni numero tärä gwi iti.',
    geo_btn:               '📍 Iti ñö gwi',
    geo_pending:           'Ni ñö tiribä.',
    btn_ticket:            '⚡ Iti tärä kite',
    historial_title:       'Iti käite tärä mün',
    tramites_sub:          'Ni trämite tärä celular gwi.',
    rendicion_sub:         'Tärä ngwane alcalde gwi.',
    opendata_label:        'Meri tärä gwi nibi.',
    footer_tagline:        'Mün Tierras Altas tärä nibi.',
    ticket_ok_title:       'Iti tärä ngiäkäre!',
    ticket_ok_sub:         'Ni iti tärä mün gwi. Numero ni tärä kite.',
